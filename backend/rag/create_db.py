...
def _parse_docs_with_unified_parser(file_path: str, filename: str, purpose: Optional[str] = None) -> List[Document]:
    ...
    if ext == ".pdf":
        parsed = parse_pdf(file_path, upload_root=upload_root, owner_id="kb", parse_mode="create_db")
    elif ext == ".docx":
        ...
        parsed = parse_pdf(converted_pdf, upload_root=upload_root, owner_id="kb", parse_mode="create_db_doc")
...
def _resolve_dashscope_audio_base() -> str:
    ...
    if llm_base and "dashscope" in llm_base.lower():
